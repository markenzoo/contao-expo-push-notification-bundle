...
namespace Markenzoo\ContaoExpoPushNotificationBundle\Model;

use Contao\Model;

class ExpoPushNotificationModel extends Model
{
    /**
     * Table name.
     *
     * @var string
     */
    protected static $strTable = 'tl_expo_push_notification';
}
